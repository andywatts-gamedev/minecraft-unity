...
//
//             var block = World.Instance.BlockStates[voxel].Block;
//             var otherBlock = World.Instance.BlockStates[adjacentVoxel].Block;
...
//             new VertexAttributeDescriptor( VertexAttribute.Color, VertexAttributeFormat.UNorm8, dimension: 4, stream: 2 ), // TextureIndex, Metallic, Smoothness, 0
//         });
...
//         var colors = meshData.GetVertexData<Color32>(2); // TextureIndex, Metallic, Smoothness, 0
//
